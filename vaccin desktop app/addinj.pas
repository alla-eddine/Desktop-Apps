...
begin
panel3.Hide;
panel1.Caption:= ' ≈÷«›…  ÿ⁄Ì„ ··„Ê·Êœ :   '  + mdata.data.childfullname.Text ;
...
if (combobox1.Text = '')
  ...
  begin
   with mdata.data.injection1 do
    ...
    then  showmessage(' „  ≈÷«›… √Ê  ŒÿÌ «· ÿ⁄Ì„ „‰ ﬁ»· Ì—ÃÏ «· √ﬂœ „‰ ≈”„ «·Õﬁ‰…')
    else panel3.Show;
  end;
end;
//------------------------------------------------------------------------------
...
begin
 ...
 if  (data.child.Fields[combobox1.ItemIndex+20].Text <> '')
  ...
  begin
    if (combobox1.Text = '') then showmessage('⁄·Ìﬂ ≈Œ Ì«— Õﬁ‰… √Ê·«  ')
    else
      begin
...
begin
if (combobox1.Text = '')  then showmessage(' «·—Ã«¡ ≈Œ Ì«— Õﬁ‰… ')
else
 begin
  if (combobox2.Text = '')  then showmessage(' «·—Ã«¡ «Œ Ì«— ﬁ«⁄… «·⁄·«Ã ')
  else
  begin
   with mdata.data.injection1 do
      begin
    ...
    then
    begin
      showmessage(' „  ≈÷«›… √Ê  ŒÿÌ «· ÿ⁄Ì„ „‰ ﬁ»· Ì—ÃÏ «· √ﬂœ „‰ ≈”„ «·Õﬁ‰…')
    end
    else
    begin
    data.injection.Insert;
