...
namespace SalesApp
{
    public partial class frm_PayPuy : Form
    {
        public frm_PayPuy()
        {
            InitializeComponent();
        ...
        private void frm_PayPuy_Load(object sender, EventArgs e)
        {
            try
            {
                TxtPaid.Focus();
        ...
        private void frm_PayPuy_KeyDown(object sender, KeyEventArgs e)
        {
