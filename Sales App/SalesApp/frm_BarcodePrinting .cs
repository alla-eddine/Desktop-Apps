...
namespace SalesApp
{
    public partial class frm_BarcodePrinting : Form
    {
        public frm_BarcodePrinting()
        {
            InitializeComponent();
        }
        ...
        private void frm_BarcodePrinting_Load(object sender, EventArgs e)
        {
            FillPro();
        ...
        private void cbxProducts_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (cbxProducts.Items.Count >= 1)
            {
                ...
                if (tbl.Rows.Count >= 1)
                {
                    ...
                    txtBarcode.Text = tbl.Rows[0][10].ToString();
                    txtSalesPrice.Text = tbl.Rows[0][7].ToString();
                }
        ...
        private void frm_BarcodePrinting_FormClosing(object sender, FormClosingEventArgs e)
        {
